...
sudo -u postgres /usr/pgsql-12/bin/psql -c "ALTER USER fusionpbx WITH PASSWORD '$database_password';"
sudo -u postgres /usr/pgsql-12/bin/psql -c "ALTER USER freeswitch WITH PASSWORD '$database_password';"
...
sed -i /etc/freeswitch/autoload_configs/xml_cdr.conf.xml -e s:"{domain_name}:172.17.0.3:"
